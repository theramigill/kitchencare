...
type DigitalContractScreenNavigationProp = StackNavigationProp<any>;
type DigitalContractScreenRouteProp = RouteProp<{ DigitalContract: { planType: string } }, 'DigitalContract'>;

const DigitalContractScreen = () => {
  const navigation = useNavigation<DigitalContractScreenNavigationProp>();
  const route = useRoute<DigitalContractScreenRouteProp>();
  const planType = route.params?.planType || '3-Year Standard';
        ...
        <View style={styles.contractContainer}>
          ...
          <View style={styles.contractSection}>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailValue}>{planType} Protection</Text>
            </View>
            <View style={styles.detailRow}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => {
              // In a real app, this would submit acceptance and navigate
